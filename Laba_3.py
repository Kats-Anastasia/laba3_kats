...
def plant(a, x, b, y):
    ...
    graph.penSize(2)
    # Далее ветки
    graph.polyline([(119 * a + x, 27 * b + y),
                    (152 * a + x, 30 * b + y),
                    (174 * a + x, 37 * b + y),
                    (199 * a + x, 49 * b + y),
                    (213 * a + x, 58 * b + y),
                    (229 * a + x, 71 * b + y)])
    graph.polyline([(274 * a + x, 57 * b + y),
                    (286 * a + x, 41 * b + y),
                    (304 * a + x, 26 * b + y),
                    (326 * a + x, 14 * b + y),
                    (342 * a + x, 7 * b + y),
                    (362 * a + x, 4 * b + y),
                    (376 * a + x, 2 * b + y)])
    graph.polyline([(270 * a + x, 113 * b + y),
                    (274 * a + x, 103 * b + y),
                    (280 * a + x, 96 * b + y),
                    (287 * a + x, 88 * b + y),
                    (297 * a + x, 80 * b + y),
                    ...
                    (329 * a + x, 78 * b + y),
                    (333 * a + x, 79 * b + y)])
    graph.polyline([(170 * a + x, 105 * b + y),
                    (178 * a + x, 102 * b + y),
                    (187 * a + x, 100 * b + y),
                    (194 * a + x, 100 * b + y),
                    (203 * a + x, 102 * b + y),
...
def panda(x, y, a):
    ...
    panda_list.append(graph.polygon([(318 * a + x, 122 * a + y),
                                     (328 * a + x, 125 * a + y),
                                     (339 * a + x, 133 * a + y),
                                     (358 * a + x, 171 * a + y),
                                     (358 * a + x, 196 * a + y),
    ...
    panda_list.append(graph.polygon([(276 * a + x, 158 * a + y),
                                     ...
                                     (303 * a + x, 131 * a + y),
                                     (276 * a + x, 158 * a + y)]))
    panda_list.append(graph.polygon([(340 * a + x, 133 * a + y),
                                     (346 * a + x, 131 * a + y),
                                     (353 * a + x, 133 * a + y),
                                     (361 * a + x, 142 * a + y),
                                     (363 * a + x, 146 * a + y),
    ...
    panda_list.append(graph.polygon([(286 * a + x, 173 * a + y),
                                     ...
                                     (281 * a + x, 175 * a + y),
                                     (286 * a + x, 173 * a + y)]))
    panda_list.append(graph.polygon([(278 * a + x, 191 * a + y),
                                     (272 * a + x, 230 * a + y),
                                     (274 * a + x, 244 * a + y),
                                     (276 * a + x, 256 * a + y),
                                     (299 * a + x, 271 * a + y),
                                     ...
                                     (281 * a + x, 202 * a + y),
                                     (278 * a + x, 191 * a + y)]))
    panda_list.append(graph.polygon([(404 * a + x, 187 * a + y),
                                     (409 * a + x, 191 * a + y),
                                     (411 * a + x, 201 * a + y),
                                     (411 * a + x, 219 * a + y),
                                     (407 * a + x, 239 * a + y),
